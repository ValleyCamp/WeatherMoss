...
config :weather_moss, WeatherMossWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: WeatherMossWeb.ErrorHTML, json: WeatherMossWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: WeatherMoss.PubSub,
  live_view: [signing_salt: "RG93rgpQ"]
...
config :weather_moss, WeatherMoss.Mailer, adapter: Swoosh.Adapters.Local
