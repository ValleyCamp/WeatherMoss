defmodule WeatherMossWeb.GaugeLine do
  ...
  def update_raw_bg_svg_style_attr_string(%GaugeLine{} = line) do
    %{line | raw_bg_svg_style_attr_string: "fill=\"transparent\" stroke=\"#{line.bgStroke}\" stroke-width=\"#{line.bgStrokeWidth}\" stroke-linecap=\"#{line.strokeLinecap}\"" }
  end

  def update_raw_fill_svg_style_attr_string(%GaugeLine{} = line) do
    %{line | raw_fill_svg_style_attr_string: "fill=\"transparent\" stroke=\"#{line.fillStroke}\" stroke-width=\"#{line.fillStrokeWidth}\" stroke-linecap=\"#{line.strokeLinecap}\"#{raw_fill_svg_dasharray_attr_string(line)}" }
  end
  ...
  #####
  # Helper methods for the update_* methods
  #####

  def raw_fill_svg_dasharray_attr_string(%GaugeLine{} = line) do
