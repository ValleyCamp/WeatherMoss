defmodule WeatherMossWeb.GaugeArc do
  ...
  defstruct [
    ...
    raw_bg_svg_style_attr_string: "",
    raw_fill_svg_style_attr_string: "",
  ...
  @type t() :: %__MODULE__{
    ...
    raw_bg_svg_style_attr_string: String.t,
    raw_fill_svg_style_attr_string: String.t,
  ...
  def build_initial_values(arc) do
    arc
    |> update_svg_bg_path_string()
    |> update_svg_fill_path_string()
    |> update_raw_bg_svg_style_attr_string()
    |> update_raw_fill_svg_style_attr_string()
    |> update_wind_transparencies()
  end

  @spec rebuild_changing_values(GaugeArc.t()) :: GaugeArc.t()
  def rebuild_changing_values(arc) do
    arc
    |> update_svg_fill_path_string()
    |> update_raw_fill_svg_style_attr_string()
    |> update_wind_transparencies()
  ...
  #####
  def update_svg_bg_path_string(arc) do
    %{arc | svg_bg_path_string: svg_gauge_arc_path(arc) }
  end

  def update_svg_fill_path_string(arc) do
    %{arc | svg_fill_path_string: svg_gauge_arc_path(arc) }
  end

  def update_raw_bg_svg_style_attr_string(arc) do
    %{arc | raw_bg_svg_style_attr_string: "fill=\"#{arc.bgFill}\" stroke=\"#{arc.bgStroke}\" stroke-width=\"#{arc.bgStrokeWidth}\" stroke-linecap=\"#{arc.bgStrokeLinecap}\"" }
  end

  def update_raw_fill_svg_style_attr_string(arc) do
    %{arc | raw_fill_svg_style_attr_string: "fill=\"transparent\" stroke=\"#{arc.fillStroke}\" stroke-width=\"#{arc.fillStrokeWidth}\" stroke-linecap=\"#{arc.fillStrokeLinecap}\"#{raw_svg_dasharray_attr_string(arc)}" }
  end
  
  def update_wind_transparencies(arc) do
